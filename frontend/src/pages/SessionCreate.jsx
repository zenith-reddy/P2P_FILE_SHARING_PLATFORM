...
const SessionCreate = () => {
  ...
  const shareWhatsApp = () => {
    window.open(`https://wa.me/?text=${encodeURIComponent('Join my secure session: ' + sessionUrl)}`, '_blank');
  };

  const shareTelegram = () => {
    window.open(`https://t.me/share/url?url=${encodeURIComponent(sessionUrl)}&text=${encodeURIComponent('Join my secure session')}`, '_blank');
  };
      ...
      <div className="session-card">
        ...
        <div className="connection-visual">
          ...
          {/* <div className="avatar-group">
            ...
            <span className="avatar-label">Peer</span>
          </div> */}
        </div>
...
const LockIconSmall = () => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6b7280" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{marginRight: '6px'}}>
      <rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect>
      <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
    </svg>
);
